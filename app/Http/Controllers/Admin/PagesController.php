...
class PagesController extends Controller
{
    ...
    public function index(IndexPage $request)
    {
        ...
        $data = AdminListing::create(Page::class)->processRequestAndGet(
            ...
            ['id', 'author_id', 'title', 'is_published', 'seo_description', 'seo_keywords', 'seo_title'],

            // set columns to searchIn
            ['id', 'title', 'image', 'slug', 'body', 'seo_description', 'seo_keywords', 'seo_title']
        );
    ...
    {
        return Excel::download(app(PagesExport::class), 'pages.xlsx');
    }
}
