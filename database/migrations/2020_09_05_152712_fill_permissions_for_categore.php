...
class FillPermissionsForCategore extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCategore constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.categore',
            'admin.categore.index',
            'admin.categore.create',
            'admin.categore.show',
            'admin.categore.edit',
            'admin.categore.delete',
            'admin.categore.bulk-delete',
        ]);
