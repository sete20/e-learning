...
class FillPermissionsForTestsSolf extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTestsSolf constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tests-solf',
            'admin.tests-solf.index',
            'admin.tests-solf.create',
            'admin.tests-solf.show',
            'admin.tests-solf.edit',
            'admin.tests-solf.delete',
            'admin.tests-solf.bulk-delete',
        ]);
