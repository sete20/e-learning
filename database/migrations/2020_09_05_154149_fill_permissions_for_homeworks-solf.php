...
class FillPermissionsForHomeworksSolf extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHomeworksSolf constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.homeworks-solf',
            'admin.homeworks-solf.index',
            'admin.homeworks-solf.create',
            'admin.homeworks-solf.show',
            'admin.homeworks-solf.edit',
            'admin.homeworks-solf.delete',
            'admin.homeworks-solf.bulk-delete',
        ]);
